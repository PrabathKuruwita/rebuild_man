    ...
    <div className="min-h-screen bg-linear-to-br from-sky-50 via-white to-indigo-50">
      <section className="relative overflow-hidden border-b border-sky-100 bg-linear-to-r from-sky-700 via-blue-700 to-indigo-700 px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-6xl text-center">
          <h1 className="text-4xl md:text-6xl font-black tracking-tight mb-6 leading-tight text-white">
            About <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-sky-200">Parithyaga</span>
          </h1>
          <p className="mt-5 max-w-3xl mx-auto text-xl text-sky-100 sm:text-2xl font-medium">
            Turning donation needs into clear action and measurable impact.
          </p>
          <p className="mt-5 max-w-2xl mx-auto text-base text-sky-50/80 sm:text-lg">
          ...
          <div className="mt-8 flex flex-wrap gap-3 justify-center">
            <Link href="/" className="rounded-full bg-white px-5 py-3 text-sm font-semibold text-blue-700 shadow-lg transition hover:-translate-y-0.5 hover:shadow-xl">
              View Impact Stories
            </Link>
            <Link href="/needs" className="rounded-full border border-white/40 bg-white/10 px-5 py-3 text-sm font-semibold text-white backdrop-blur-sm transition hover:bg-white/20">
              Browse Active Needs
            </Link>
          </div>
        </div>
      ...
      <section className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid gap-6 md:grid-cols-3">
          {pillars.map((pillar) => (
            <article key={pillar.title} className="rounded-none border border-blue-100 bg-white/90 p-6 shadow-sm backdrop-blur-sm">
        ...
        <div className="mt-8 rounded-none border border-slate-100 bg-white/90 p-8 shadow-sm backdrop-blur-sm">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <div className="rounded-none bg-sky-50 p-5">
            ...
            <div className="rounded-none bg-emerald-50 p-5">
            ...
            <div className="rounded-none bg-amber-50 p-5">
            ...
            <div className="rounded-none bg-indigo-50 p-5">
